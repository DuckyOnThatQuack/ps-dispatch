Locales = {
    ...
    ['sv'] = {
        ['unknown_caller'] = "Okänd samtalare",
        ['caller_unknown'] = "Okänd",
        ['caller_local'] = "Local",
        ['call_from'] = "Samtal ifrån ",
        ['two_door'] = "Två-dörr ",
        ['three_door'] = "Tre-dörr ",
        ['four_door'] = "Fyr-dörr ",
        ['compact'] = "Kompakt", 
        ...
        ['coupe'] = "Coupé",
        ['muscle'] = "Muskelbil",
        ['sports_classic'] = "Sportklassiker",
        ['sports'] = "Sportbil",
        ['super'] = "Superbil",
        ['motorcycle'] = "Motorcykel",
        ['offroad'] = "Terrängbil",
        ['industrial'] = "Industrifordon",
        ['utility'] = "Nyttofordon",
        ['van'] = "Skåpbil",
        ['service'] = "Servicebil",
        ['military'] = "Militärfordon",
        ['truck'] = "lastbil",
        -- DISPATCH MESSAGES
        ['vehicleshots'] = "Skottlossning från Fordon",
        ['shooting'] = "Skottlossning",
        ['melee'] = "Kamp Pågår",
        ['driveby'] = "Drive-by-skytte",
        ['speeding'] = "Vårdslös körning",
        ['autotheft'] = "Stöld av ett motorfordon",
        ['persondown'] = "Person är skadad",
        ['storerobbery'] = "Butiksrån",
        ['fleecabank'] = "Fleeca Bankrån",
        ['paletobank'] = "Paleto Bankrån",
        ['pacificbank'] = "Pacific Bankrån",
        ['prisonbreak'] = "Flykt från Fängelse",
        ['vangelico'] = "Vangelico Rån",
        ['houserobbery'] = "Husrån",
        ['drugsell'] = "Misstänkt Drogförsäljning",
        ['carjacking'] = "Bilstöld", 
        ['vehicletheft'] = "fordonsstöld", 
        ['officerdown'] = "Officer nere",
        ['emsdown'] = "Ambulans nere",
        ['artgalleryrobbery'] = "Konsthallsrån",
        ['humanerobbery'] = "Humane Labs Rån",
        ['trainrobbery'] = "Tågrån",
        ['vanrobbery'] = "Säkerhetsbilsrån",
        ['underground'] = "Bunkerrån",
        ['drugboatrobbery'] = "Misstänkt Båt",
        ['unionrobbery'] = "Union Depository Rån",
        ['carboosting'] = "Bil Boosting Pågår",
        ['yachtheist'] = "Yacht Heist Pågår",
        ['susactivity'] = "Misstänkt Aktivitet",
    },
